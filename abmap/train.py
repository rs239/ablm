...
def train_model(device_num, log_name, exec_type, num_epochs, model_loadpath, model_savepath, region,
    ...
    if exec_type == 'train':
        ...
        for i in range(num_epochs):
            ...
            if (i+1)%ckpt_every == 0 and model_savepath != "":
                ...
                savepath = os.path.join(model_savepath, '{}_epoch{}.pt'.format(emb_type, prev_epochs+i+1))
    ...
    if log_name != "":
        f = open("../../logs/{}.p".format(log_name), "wb")
        pickle.dump(logs, f)
        f.close()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--embed_dir', type=str, default="",
